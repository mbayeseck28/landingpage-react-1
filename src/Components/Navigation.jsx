  ...
  return (
    <header>
      <nav className="navbar navbar-expand-lg ">
        ...
        <a className="navbar-brand text-secondary fw-semibold" href="#test">NEXT INVEST</a>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
          <button type="button" className="btn btn-secondary rounded-0">LOGIN</button>
          </li>
          <li className="nav-item">
          <button type="button" className="btn btn-outline-secondary rounded-0">REGISTER</button>
          </li>
        </ul>
      </div>
      </div>
